...
parser = ArgumentParser(epilog=f"Example: {argv[0]} 192.168.101.14 admin P@$$w0rd123",description="Wisper helps to maintain access to a windows machine and have some other cool features like UAC Disabe,Firewall Disable,Dumping Credentials,etc.")
